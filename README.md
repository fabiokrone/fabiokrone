...
**Building AI tools for Brazilian municipalities | Founder @ TermoCerto**
...
Founder of **TermoCerto**, an AI platform that generates procurement documents (DFD, ETP, TR) for Brazilian municipalities, fully compliant with **Lei 14.133/2021**. I combine full-stack engineering with deep public sector domain knowledge to build tools that make government work better.
...
### 🏗️ [TermoCerto](https://github.com/fabiokrone/termocerto) `🚧 In Development`

AI platform that generates procurement documents (DFD, ETP, TR) via WhatsApp for Brazilian municipalities. Full compliance with Lei 14.133/2021.
...
Complete payroll & HR management system for municipal governments. Handles payroll processing, benefits, tax calculations, and regulatory compliance.

![React](https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black)
![FastAPI](https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white)
![Supabase](https://img.shields.io/badge/Supabase-3FCF8E?style=flat-square&logo=supabase&logoColor=white)

> Serving **8 municipalities** and **550+ public servants**
...
Automated time-tracking agent with advanced PL/pgSQL functions for attendance control and workforce analytics.
...
![Flowise](https://img.shields.io/badge/Flowise-6001D2?style=flat-square&logo=flowise&logoColor=white)
...
![Lei 14.133/2021](https://img.shields.io/badge/Lei_14.133%2F2021-Licitações-1A3C6E?style=flat-square)
![CLT](https://img.shields.io/badge/CLT-Servidores_Estatutários-1A3C6E?style=flat-square)
![eSocial](https://img.shields.io/badge/eSocial-RAIS_DIRF_SEFIP-1A3C6E?style=flat-square)
...
If you work with government, procurement, or public sector automation — let's talk!
